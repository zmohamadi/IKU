            ...
            <Frame title="Tools">
                <div className="intro-y col-span-6 sm:col-span-4 md:col-span-3 xxl:col-span-2">
                    <div className="file box rounded-md px-5 pt-8 pb-5 sm:px-5 relative zoom-in">
                        ...
                        <Link href="#" className="w-3/5 file__icon file__icon--image mx-auto">
                        ...
                        <Link href="#" className="block font-medium mt-4 text-center truncate">
                ...
                <div className="intro-y col-span-6 sm:col-span-4 md:col-span-3 xxl:col-span-2">
                    <div className="file box rounded-md px-5 pt-8 pb-5 sm:px-5 relative zoom-in">
                        <Link href="#">
                            ...
                            <span href="#" className="block font-medium mt-4 text-center truncate">
                                {Lang("public.survey")}
                            </span>
                        </Link>
                    </div>
