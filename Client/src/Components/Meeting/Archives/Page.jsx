...
export function Page({toolsId,course,access,laraPath,nextPath=""}){
    ...
    let info = {
        ...
        url: laraPath+"/meeting/"+toolsId+"/archives",
        columns: [
            ...
            {label: "",
                ...
                jsx:(item)=><>
                    <div className='flex justify-center '>
                        ...
                        <FeatherIcon name="XOctagon" access={access} tooltip={Lang('public.delete')} color="darkred" onClick={()=>destroy(laraPath+"/meeting-files/"+item.id)} />
                    </div>
                </>
            },
        ],
