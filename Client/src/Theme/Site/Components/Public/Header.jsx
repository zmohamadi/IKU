				...
				<nav id="navigation" className="navigation navigation-landscape">
					<div className="nav-header">
						...
						<div className="mobile_nav">
							<ul>
								<li>
									<Link href="#" data-toggle="modal" data-target="#login" className="crs_yuo12 w-auto text-white theme-bg">
					...
					<div className="nav-menus-wrapper">
						<ul className="nav-menu">
							...
							<li><a href="https://forum.afg-womens-academy.org/index.php">Forum</a></li>
