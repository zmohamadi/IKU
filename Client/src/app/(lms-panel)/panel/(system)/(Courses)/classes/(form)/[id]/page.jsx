...
export default function View({params}){
    ...
    // console.log(component?.state?.info?.course?.title);
    ...
    return(<>
            ...
            <div className="intro-y news">
                    ...
                    <div className="intro-y text-gray-700 dark:text-gray-600 mt-3 text-xs sm:text-sm"> 
                        <span className="mx-1">•</span>{courseClass?.year} - {courseClass?.semester}
                    ...
                    {/* <table>
                        ...
                        <tbody>
                            {Tools.getArray(courseClass).map((lclass, index)=>
                                 <tr>
                                        <td>{lclass?.year}</td>
