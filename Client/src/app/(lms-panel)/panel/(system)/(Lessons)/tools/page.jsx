...
export default function List(){
    ...
    let info = {
        ...
        url: laraAdmin+"/tools",
        columns: [
            // {label: "image", jsx:(item)=><img className="rounded-full" src={mediaPath+"/lessontools/"+item.pic} width={70} height={70} alt="Picture" />},
            ...
            {label: "",
                ...
                jsx:(item)=><>
                    <div className='flex justify-center '>
                        ...
                        <FeatherIcon name="XOctagon" tooltip={Lang('public.delete')} color="darkred" onClick={()=>destroy(laraAdmin+"/tools/"+item.id)} />
                    </div>
                </>
            },
        ],
