...
class CreateEduPostFilesTable extends Migration
{

    public function up()
    {
        Schema::create('edu_post_files', function (Blueprint $table) {
            $table->engine  = 'MyISAM';
            $table->charset = 'utf8';
            $table->collation = 'utf8_persian_ci';
            $table->id();
            $table->integer('post_id')->nullable()->comment('شناسه مقاله');
    ...
    {
        Schema::dropIfExists('edu_post_files');
    }
}
